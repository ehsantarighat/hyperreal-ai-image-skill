...
BRANCH="${BRANCH:-main}"
SKILL_NAME="${SKILL_NAME:-influencer-ugc-image-generation-orchestrator}"
...
printf "Then run: pip install -r %s/requirements.txt\n" "$TARGET_DIR"
printf "Set OPENAI_API_KEY before image generation.\n"
